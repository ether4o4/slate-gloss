...
const MveScreen: React.FC<{ onClose?: () => void }> = ({ onClose }) => {
...
const styles = StyleSheet.create({
  // Solid backdrop so the screen also works full-screen inside a Modal.
  ...
  closeText: { color: '#eaf4ff', fontSize: 14, fontWeight: '700' },
  header: {
