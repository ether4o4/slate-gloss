...
export const AI_THEMES: ThemeDef[] = [
  {
    ...
    colors: ['rgba(26,42,108,0.88)', 'rgba(76,20,110,0.92)'],
  },
  {
    name: 'Vaporwave',
    colors: ['rgba(255,110,199,0.78)', 'rgba(110,90,255,0.86)'],
  },
  { name: 'Matrix', colors: ['rgba(12,46,18,0.9)', 'rgba(0,14,5,0.96)'] },
  { name: 'Inferno', colors: ['rgba(158,32,20,0.88)', 'rgba(40,8,4,0.96)'] },
  {
    name: 'Cotton Candy',
    colors: ['rgba(255,170,210,0.8)', 'rgba(150,190,255,0.82)'],
  },
  {
    name: 'Gold Rush',
    colors: ['rgba(160,126,30,0.88)', 'rgba(60,44,8,0.96)'],
  },
  { name: 'Deep Sea', colors: ['rgba(10,64,86,0.88)', 'rgba(2,20,35,0.96)'] },
  {
    name: 'Synthwave Sunset',
    colors: ['rgba(255,94,98,0.82)', 'rgba(60,20,90,0.9)'],
  },
...
export const SWARM_TOOLS = [
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: {
          name: { type: 'string', description: 'Theme name, e.g. "Matrix"' },
        },
        required: ['name'],
      },
    },
  },
  {
    ...
    function: {
      name: 'list_themes',
      description:
        'List all theme names that can be applied (including secret AI-only ones).',
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: {
          name: { type: 'string', description: 'App name, e.g. "camera"' },
        },
        required: ['name'],
      },
    },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Open the system image picker so the user can choose a wallpaper.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Prompt the user to set NeverSoft OS as the default home app.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'get_status',
      description:
        'Get device status: time, battery, RAM, storage, and number of installed apps.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'list_commands',
      description:
        'List everything you can do for the user (themes, apps, widgets, device).',
      parameters: { type: 'object', properties: {} },
    },
  },
];
