        ...
        <Pressable onPress={() => {}} style={styles.center}>
          <GlassSurface radius={18} style={styles.card}>
            ...
            <FlatList
              ...
              style={styles.list}
              ListEmptyComponent={
                <Text style={styles.empty}>The Recycle Bin is empty.</Text>
              }
              renderItem={({ item }) => {
                ...
                return (
                  <View style={styles.row}>
                    ...
                    <Pressable
                      onPress={() => onRestore(item.packageName)}
                      style={styles.action}
                    >
                      <Text style={styles.actionText}>Restore</Text>
                    </Pressable>
                    <Pressable
                      onPress={() => onUninstall(item.packageName)}
                      style={styles.action}
                    >
                      <Text
                        style={[styles.actionText, { color: Theme.danger }]}
                      >
                        Uninstall
                      </Text>
                    </Pressable>
            ...
            <Pressable
              ...
              style={[styles.emptyBtn, items.length === 0 && styles.disabled]}
            >
