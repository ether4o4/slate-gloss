...
export const ContextMenu: React.FC<Props> = ({visible, title, items, onClose}) => {
  return (
...
const styles = StyleSheet.create({
  overlay: {flex: 1, backgroundColor: 'rgba(0,0,0,0.45)', justifyContent: 'center', padding: 36},
  ...
  row: {flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 13, paddingHorizontal: 12, borderRadius: 10},
