    ...
    >
      <Pressable style={styles.overlay} onPress={onClose}>
        <Pressable
          ...
          style={[
            styles.panelWrap,
            { width: dims.w, height: renderH, marginBottom: 72 },
          ]}
        >
                ...
                <FlatList
                  ...
                  ListHeaderComponent={
                    <View>
                      ...
                      {recentApps.length === 0 ? (
                        <Text style={styles.hint}>
                          Recently opened apps appear here.
                        </Text>
                      ) : (
                        recentApps.map(a => (
                          <ProgramRow
...
const FooterBtn: React.FC<{
  ...
  <Pressable
    onPress={onPress}
    style={({ pressed }) => [styles.footerBtn, pressed && styles.rowPressed]}
  >
