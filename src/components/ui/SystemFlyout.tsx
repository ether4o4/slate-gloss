                  ...
                  <View style={styles.card}>
                    ...
                    {weather ? (
                      ...
                      <Text style={styles.muted}>
                        Weather unavailable (no connection?).
                      </Text>
                    )}
                  </View>
                )}
                    ...
                    {system ? (
                      <>
                        <Text style={styles.sysLabel}>
                          RAM {system.ramUsedPct}% ·{' '}
                          {system.ramUsedGb.toFixed(1)}/
                          {system.ramTotalGb.toFixed(1)} GB
                        </Text>
                        <Bar pct={system.ramUsedPct} color="#7fb3ff" />
                        <Text style={[styles.sysLabel, { marginTop: 8 }]}>
                          Storage {system.storageUsedPct}% ·{' '}
                          {system.storageFreeGb.toFixed(0)} GB free
                        </Text>
                ...
                {has('notes') && (
                  <View style={styles.card}>
                    ...
                    >
                      <Text
                        style={
                          notes ? styles.notesPreview : styles.notesPlaceholder
                        }
                        numberOfLines={6}
                      >
