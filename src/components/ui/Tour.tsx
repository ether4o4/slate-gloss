...
export const Tour: React.FC<Props> = ({
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      action: {label: isDefault ? 'Set again' : 'Set as default', run: onSetDefault},
      done: isDefault,
    },
    {
      emoji: '🔋',
    ...
    },
    {
      ...
      action: {label: notifAccess ? 'Open settings' : 'Grant access', run: onNotifAccess},
      done: notifAccess,
    },
    {
      emoji: '✦',
  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <View style={styles.container}>
        <LinearGradient colors={['#0d2137', '#13314f', '#0a1a2c']} style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  doneBadge: {color: '#4ade80', fontSize: 14, fontWeight: '700', marginBottom: 8},
  ...
  back: {color: Theme.textDim, fontSize: 16, fontWeight: '600', paddingVertical: 10, paddingHorizontal: 8},
  nextBtn: {backgroundColor: 'rgba(255,255,255,0.16)', borderRadius: 24, paddingHorizontal: 30, paddingVertical: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: Theme.border},
